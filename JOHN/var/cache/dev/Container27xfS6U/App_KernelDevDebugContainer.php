...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\APICatalogController' => 'getAPICatalogControllerService',
            'App\\Controller\\APIOrderController' => 'getAPIOrderControllerService',
            'App\\Controller\\APIShoppingCartController' => 'getAPIShoppingCartControllerService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3LukVXOkua', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.product' => ['privates', 'security.firewall.map.context.product', 'getSecurity_Firewall_Map_Context_ProductService', true],
            ...
            'security.firewall.map.context.product' => '?',
            ...
            yield 'security.firewall.map.context.products' => ($this->privates['.security.request_matcher.hJtHPxr'] ?? ($this->privates['.security.request_matcher.hJtHPxr'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/products')));
            yield 'security.firewall.map.context.product' => ($this->privates['.security.request_matcher.ef7JOpn'] ?? ($this->privates['.security.request_matcher.ef7JOpn'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/product/')));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'security.products._indexed_authenticators' => [

            ],
            'security.product._indexed_authenticators' => [
